...
The two figures in this note are generated by:

```bash
python notes/6_regression/resources/plot_interpolation.py
```

The script writes SVG files to `notes/6_regression/resources/plots/`.
